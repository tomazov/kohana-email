...
abstract class KO7_Email
{
    ...
    {
        if ($config === NULL) {
            $this->_config = KO7::$config->load('email');
        } else {
            $this->_config = $config;
        }

        if (!isset($this->_config['driver'])) {
            throw new KO7_Exception('Email driver not defined in configuration file');
        }
    ...
    {
        $this->_from = new KO7_Email_Recipient($email, $name, 'from');
    ...
    {
        $this->_recipients[] = new KO7_Email_Recipient($email, $name, $type);
    ...
    {
        $this->_recipients[] = new KO7_Email_Recipient($email, $name, 'cc');
    ...
    {
        $this->_recipients[] = new KO7_Email_Recipient($email, $name, 'bcc');
    ...
    {
        $this->_recipients[] = new KO7_Email_Recipient($email, $name, 'reply-to');
